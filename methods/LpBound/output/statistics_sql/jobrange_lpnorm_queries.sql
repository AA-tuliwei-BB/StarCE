...
SELECT
    ...
    TITLE.PHONETIC_CODE AS TITLE_PHONETIC_CODE, TITLE.PRODUCTION_YEAR AS TITLE_PRODUCTION_YEAR, TITLE.KIND_ID AS TITLE_KIND_ID, TITLE.SEASON_NR AS TITLE_SEASON_NR, TITLE.IMDB_INDEX AS TITLE_IMDB_INDEX, TITLE.EPISODE_NR AS TITLE_EPISODE_NR, TITLE.SERIES_YEARS AS TITLE_SERIES_YEARS
FROM CAST_INFO
JOIN TITLE
