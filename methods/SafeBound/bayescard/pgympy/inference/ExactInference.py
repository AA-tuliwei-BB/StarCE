...
import copy
from pgympy.inference import Inference
from pgympy.factors import factor_product
from pgympy.models import BayesianModel, JunctionTree
from pgympy.inference.EliminationOrder import (
    WeightedMinFill,
    MinNeighbors,
    MinFill,
    MinWeight,
)
from pgympy.factors.discrete import TabularCPD
