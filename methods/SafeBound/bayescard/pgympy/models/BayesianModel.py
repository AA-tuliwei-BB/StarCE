...
from pgympy.base import DAG
from pgympy.factors.discrete import (
    TabularCPD,
    JointProbabilityDistribution,
    DiscreteFactor,
)
from pgympy.factors.continuous import ContinuousFactor
from pgympy.models.MarkovModel import MarkovModel
...
class BayesianModel(DAG):
    ...
    def fit(
        ...
        """
        from pgympy.estimators import MaximumLikelihoodEstimator, BaseEstimator
    ...
    def update(self, data):
        from pgympy.estimators import MaximumLikelihoodEstimator
        estimator = MaximumLikelihoodEstimator
