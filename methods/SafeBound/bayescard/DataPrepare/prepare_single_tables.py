...
def prepare_single_table(schema_graph, table, path, max_distinct_vals=1000000, csv_seperator=',',
    ...
    for relationship_obj in incoming_relationships:
        ...
        neighbor_table_data = read_table_csv(neighbor_table_obj, csv_seperator=csv_seperator,
                                             stats=stats).set_index(right_attribute, drop=False)
...
def prepare_all_tables(schema_graph, path, csv_seperator=',', max_table_data=20000000, stats=False):
