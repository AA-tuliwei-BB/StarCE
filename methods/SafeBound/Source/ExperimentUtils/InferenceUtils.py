...
def evaluate_inference_postgres(benchmark, 
    ...
    if benchmark == 'JOBLight':
        ...
        queryJGs =  [removePKJoins(x, IMDB_FKtoKDict) for x in SQLFileToJoinQueryGraphs(rootFileDirectory + 'Workloads/JOBLightQueries.sql')]
        dbConn = getDBConn('imdb_fk_pk')
    elif benchmark == 'JOBLightRanges_FK_PK':
        queryJGs =  [removePKJoins(x, IMDB_FKtoKDict) for x in SQLFileToJoinQueryGraphs(rootFileDirectory + 'Workloads/JOBLightRangesQueries.sql')]
        dbConn = getDBConn('imdb_fk_pk')
    elif benchmark == 'JOBM_FK_PK':
        queryJGs =  [removePKJoins(x, IMDB_FKtoKDict) for x in SQLFileToJoinQueryGraphs(rootFileDirectory + 'Workloads/JOBMQueries.sql')]
        dbConn = getDBConn('imdb_fk_pk')
    elif benchmark == 'Stats_FK_PK':
        queryJGs =  [removePKJoins(x, Stats_FKtoKDict) for x in SQLFileToJoinQueryGraphs(rootFileDirectory + 'Workloads/StatsQueries.sql')]
