...
CostModel::CostModel(QueryGraphManager &query_graph_manager, bool can_use_starce)
    : query_graph_manager(query_graph_manager), cardinality_estimator(can_use_starce) {
}
