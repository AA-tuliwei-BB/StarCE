...
unique_ptr<LogicalOperator> JoinOrderOptimizer::Optimize(unique_ptr<LogicalOperator> plan,
	...
	bool can_use_starce = false;
	bool reorderable = query_graph_manager.Build(*this, *op, can_use_starce);
	...
	if (reorderable) {
		...
		auto cost_model = CostModel(query_graph_manager, can_use_starce);
